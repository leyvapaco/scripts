...
*                                                                                 *
*     1) Opción 1 o Añadir: Añadir                                               *
*        (añade un registro Nombre, Dirección, Telefono).                         *
*     2) Opción 2 o Buscar: Buscar                                               *
*        (buscar entradas por nombre, dirección o teléfono).                      *
*     3) Opción 3 o Listar: Listar (visualizar todo el archivo).                 *
*     4) Opción 4 o Ordenar: Ordenar (ordenar los registros alfabéticamente).    *
*     5) Opción 5 o Borrar: Borrar (borrar el archivo).                          *
*     6) Opción 6 o Salir: Salir del gestor.                                     *
*                                                                                 *
***********************************************************************************
DESCRIPCION_MENU
    echo ""
